...
**Snapshot 0.5.15 (portal app):** Freight region dashboard filters (Week + Sales Director + full filter row); Build Health + Change Log portal tabs; daily Juanita share sync (`freight:sync-source`, `Everde-Freight-DailyCheck`); YTD through 6-JUN-2026 on Blob. **0.5.14:** Jonathan gap analysis — Top Opps, Internal Freight, Sales Performance. Production: https://everde-operations.vercel.app . See `scripts/freight/CURSOR_Freight_Remaining_Items.md` and `scripts/freight/FREIGHT_DASHBOARD_DATA.md`.
