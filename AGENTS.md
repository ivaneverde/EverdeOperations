...
**Snapshot 0.5.13 (portal app):** CEO-demo polish — dynamic freight YTD dates from Blob meta; portal source paths (freight 5-27, retail Wk21, nursery 05-26); home copy for production; OR sales plan shows clear pending state; stale freight nav items hidden. **0.5.12:** collapsible sidebar + scroll fix. Production: https://everde-operations.vercel.app . See `scripts/freight/FREIGHT_DASHBOARD_DATA.md` and `scripts/windows/WEEKLY_DROP_AGENT.md`.
