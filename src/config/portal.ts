...
export const PORTAL_SECTIONS: PortalSection[] = [
  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        navAccent: "C0392B",
        notes: "Freight flagged loads (low fill rate). Shown under Retail for exec convenience.",
      },
      {
        slug: "freight-top-opportunities-last-week",
        title: "Freight — Top Opportunities Last Week",
        sourceRelativePath: FREIGHT_DASHBOARD_SOURCE,
      ...
      },
      {
        ...
        title: "Freight — Sales Performance",
        sourceRelativePath: FREIGHT_DASHBOARD_SOURCE,
  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        navAccent: "2F5233",
        notes:
          "Oregon sales plan embed (Everde_OR_Sales_Plan_Dashboard.html). Run npm run sales-plan:or-extract-publish when the OR workbook is on the share.",
      },
    ],
  },
  {
    ...
    title: "Weather",
    summary:
      "Regional forecasts and sales × weather crosswalk for West Coast and other Everde markets.",
    shareFolder: WEATHER_DATA_ROOT,
    sectionNotes:
      "Live Open-Meteo forecast in browser; crosswalk JSON from the weather share pipeline.",
    reports: [
      {
  ...
  },
  {
    ...
    sectionSourceRelativePath:
      "Sales Inventory Availability\\XXTT_INV_QA_LANDSCAPE_INV_PL_67786622_1.xls",
    sectionNotes:
