/**
 * Publish local wcro_data.json to Azure Blob.
 *
...
const localPath = process.argv[2] || "data/wcro_data.json";
const abs = path.resolve(localPath);
if (!fs.existsSync(abs)) {
  console.error(`Missing file: ${abs}`);
  console.error("Usage: npm run publish:wcro-json -- data/wcro_data.json");
  process.exit(1);
}
