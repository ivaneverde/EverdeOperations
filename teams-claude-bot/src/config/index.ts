...
- Use **get_freight_dashboard**, **get_sales_plan_dashboard**, **get_hd_ytd_following_week**, **get_lowes_ytd_following_week**, **get_wcro_dashboard**, **get_nursery_supply**, **get_nursery_demand**, **get_grade_definitions**, and other Everde tools for deeper drill-down when the snapshot or prior tool results are not enough.
