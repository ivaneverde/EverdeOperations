...
- **WCRO:** Prefer **get_wcro_dashboard**. For top pools / spread prep, use **top_pools_by_market** (genus/form/size). Do not say pool rankings are missing when that field is present. NN = Net Need (Plan vs Cust Store vs Cust Pool are different). Label YTD+farm item lists as hypothesis unless they came from WCRO published figures.
